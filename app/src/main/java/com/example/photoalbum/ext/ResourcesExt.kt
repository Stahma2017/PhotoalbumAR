...
val Context.colors
    get() = ResourceMapper { ResourcesCompat.getColor(resources, it, theme) }
val Context.colorStateLists
    get() = ResourceMapper { ResourcesCompat.getColorStateList(resources, it, theme)!! }
val Context.dimens
...
val Context.drawables
    get() = ResourceMapper { ResourcesCompat.getDrawable(resources, it, theme)!! }
val Context.scaledDrawable
    get() = ResourceMapper { ScaledDrawable(resources, it, theme) }
val Context.fonts
    get() = ResourceMapper { ResourcesCompat.getFont(this, it)!! }
